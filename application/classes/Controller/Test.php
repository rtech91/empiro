...
class Controller_Test extends Controller {
  ...
  public function action_register()
  {
    ...
    if(!empty($test_id) && !empty($test_id) && Model_Storage::getInstance()->checkFileAccessibility($filepath)) {
      ...
      MessageHandler::getInstance()->registerMessage(I18n::get('Test file was not found! Please ask administrator for assistance.'), MessageHandler::MH_FAILURE|MessageHandler::ACCESS_USER);
    }
