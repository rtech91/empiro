...
<div class="home">
	<div class="alert-wrap">
		<div class="alert-failure"><span>Test HTML/CSS damaged</span></div>
	</div>
	<h1>HTML/CSS</h1>
	<div class="test-wrap">
		<div class="test-info">
			<div class="question-number">Question: 1/20</div>
			<div class="test-time">Time left: 00:14:27/00:30:00</div>
		</div>
		<div class="question">
		...
		<div class="result-block">
			<button class="btn-test" id="prev-page" type="button"  disabled>Previous</button>
			<button class="btn-test btn-disabled" id="next-page" type="submit" disabled>Next</button>
		</div>
	</div>
</div>
</main>